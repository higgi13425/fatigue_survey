...
# Upload data 
```{r}
read.csv(here("MeasuringFatigueInIn-UCData111024_DATA_2024-11-11_0630.csv")) -> uc_data
```
...
uc_stop_bang_4 %>% 
  dplyr::mutate(bmi_sb = as_factor(uc_stop_bang5),
                bmi_sb = fct_recode(bmi_sb, 
                                      "0" = "0",
                                    "1" = "1", 
                                    "0" = "2"), 
                bmi_sb = relevel(bmi_sb, ref = "0")) -> uc_stop_bang_5
...
uc_stop_bang_8$bmi_sb <- as.integer(uc_stop_bang_8$bmi_sb) - 1
